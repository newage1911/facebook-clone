...
export default function StoryCard({ name, src, profile }) {
  return (
    <div className="relative h-14 w-14 md:h-20 md:w-20 lg:h-56 lg:w-32 cursor-pointer overflow-x p-3 transition duraion-200 transform  ease-in hover:scale-105 hover:animate-pulse">
      <Image
